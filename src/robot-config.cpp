...
Chassis chassis(
    ...
    mik::motor_group({
		...
		mik::motor(PORT1, false, blue_6_1, "left_top_motor"), 
		mik::motor(PORT2, true, blue_6_1, "left_back_motor")
    }),
    mik::motor_group({
		mik::motor(PORT10, true, blue_6_1, "right_front_motor"), 
		mik::motor(PORT8, false, blue_6_1, "right_top_motor"), 
...
Assembly assembly(
	mik::motor(PORT4,false,blue_6_1,"outtake_motor"),
